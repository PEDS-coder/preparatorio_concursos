...
OBSERVAÇÃO IMPORTANTE: Você está analisando a parte ${i+1} de ${textChunks.length} de um documento maior.
  ...
  // Extrair apenas os cargos do edital (primeira etapa - novo fluxo)
  Future<String> extrairCargosEdital(Uint8List pdfBytes, {String? pdfName}) async {
    ...
    try {
      ...
      try {
        ...
        promptTemplate = await promptService.loadCargosEditalPrompt();
      } catch (e) {
        print('Erro ao carregar prompt de cargos: $e');
      ...
      print('Erro ao extrair cargos do edital: $e');
      rethrow;
    }
  }

  // Extrair informações básicas do edital (primeira etapa - método antigo)
  ...
  // Extrair dados do concurso e conteúdo programático para um cargo específico (segunda etapa - novo fluxo)
  Future<String> extrairConcursoConteudo(Uint8List pdfBytes, String cargoAlvo, {String? pdfName}) async {
    ...
    try {
      ...
      try {
        ...
        promptTemplate = await promptService.loadConcursoConteudoPrompt();
      } catch (e) {
        print('Erro ao carregar prompt de concurso e conteúdo: $e');
        // Usar prompt JSON como fallback
        try {
          promptTemplate = await promptService.loadContentJsonPrompt();
        } catch (e2) {
          print('Erro ao carregar prompt JSON de conteúdo: $e2');
          // Usar prompt de fallback em caso de erro
      ...
      print('Erro ao extrair dados do concurso e conteúdo programático: $e');
      rethrow;
    }
  }

  // Extrair conteúdo programático para um cargo específico (segunda etapa - método antigo)
