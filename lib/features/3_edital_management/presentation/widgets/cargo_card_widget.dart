...
/// Widget que representa um cartão de cargo na tela de seleção de cargos
class CargoCardWidget extends StatelessWidget {
  ...
  final String Function(double) formatarSalario;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Apenas salário e escolaridade conforme solicitado
              CargoInfoItemWidget(
                label: 'Salário', 
                value: 'R\$ ${formatarSalario(cargo.salario)}', 
